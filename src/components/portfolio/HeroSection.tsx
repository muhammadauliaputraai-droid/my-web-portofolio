  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[-10%] left-[-5%] w-[450px] h-[450px] rounded-full bg-blue-500/10 blur-[130px]" />
        <div className="absolute top-[20%] right-[-5%] w-[500px] h-[500px] rounded-full bg-indigo-500/8 blur-[140px]" />
        <div className="absolute bottom-[-10%] left-[25%] w-[450px] h-[450px] rounded-full bg-rose-500/8 blur-[130px]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed animate-slide-up stagger-2">
          Membangun aplikasi web modern dengan fokus pada performa, estetika bersih,
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12 animate-slide-up stagger-3">
          <Button
            size="lg"
            className="gradient-bg text-white hover:opacity-95 shadow-md hover:shadow-lg transition-all duration-300 px-8 py-6 text-base font-semibold rounded-xl"
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-border/60 hover:bg-muted/40 px-8 py-6 text-base font-semibold backdrop-blur-sm rounded-xl"
